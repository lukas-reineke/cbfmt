        ...
        App::new("Codeblock Format")
            ...
            .arg(
                Arg::with_name("files")
                    ...
                    .help("List of files to process. If no files are given codeblock-format will read from Stdin.")
                    .index(1)
...
async fn use_files(matches: ArgMatches, conf: &config::Conf) {
    ...
    let fail_early = matches.is_present("fail_early");
